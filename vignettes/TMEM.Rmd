...
the `get_GO_info` that gathers all the gene ontology information of a list of gene
...
The `get_GO_info` function returns all the `GO Terms` relevant to a user's provided list, and
