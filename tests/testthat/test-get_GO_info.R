...
testthat::test_that("get_GO_info requires a valid list of gene IDs", {
  testthat::expect_error(get_GO_info(list_of_interest = 'ERIKLARSEN', species = "HS"))
})
...
testthat::test_that("get_GO_info requires at least one valid gene ID", {
  ...
  testthat::expect_error(get_GO_info(list_of_interest = '', species = 'HS'))
})
